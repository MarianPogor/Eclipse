...
public class CreatePanel extends JPanel {
	 ...
	 * @param gui the gui object that allows access to the main GUI
	 * @param buttonHandler
	 */
	...
	/**
	 * Sets the number of parts field text
	 * @param txfCategory
	 */
	...
	/**
	 * Returns the create location button
	 * @return
	 */
