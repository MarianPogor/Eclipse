...
public class SearchPanel extends JPanel {
	...
	public SearchPanel(MainGUI gui,ButtonHandler buttonHandler) {
		...
		radioLocation.setBounds(315, 20, 75, 25);
		...
		btnRemoveFromStock = new JButton("Use one part");
	...
	public void setBtnDelete(JButton btnRemoveFromStock) {
		this.btnRemoveFromStock = btnRemoveFromStock;
	}
