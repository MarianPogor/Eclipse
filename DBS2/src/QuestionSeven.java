...
public class QuestionSeven extends QuestionRunner
{
 ...
 executeQuery("select mother.id, child.yearborn ,mother.haircolor from mother join child on Mother.ID = Child.MotherId where mother.haircolor='blond' and yearborn=2012");
